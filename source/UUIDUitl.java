...
public class UUIDUitl {
    ...
    public static final String UPPER_NUM_CHAR = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";
     ...
     * 大写的数字字母组合
     */
    public static String getUpperNumChar(int length) {
        StringBuffer sb = new StringBuffer();
        Random random = new Random();
        for (int i = 0; i < length; i++) {
            sb.append(UPPER_NUM_CHAR.charAt(random.nextInt(UPPER_NUM_CHAR.length())));
        }
        return sb.toString();
    }
